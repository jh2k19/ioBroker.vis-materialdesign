...
function createCharts(day) {
    ...
    let idDasWetter = `daswetter.0.location_1.ForecastHourly.Hour_24`;
...
function createVorschauIconListItem(day) {
    ...
    return {
        text: `<div style="margin: 0 4px; text-align: center;">${title}
            ...
            <div style="color: grey; font-size: 11px; font-family: RobotoCondensed-Light; white-space: break-spaces; margin-top: 5px; text-align: center;">${getState(`${idDasWetter}.Weather_Symbol_Description`).val}</div>
        ...
        image: getState(`${idDasWetter}.Weather_Symbol_URL`).val,
